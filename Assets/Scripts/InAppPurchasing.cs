...
public class InAppPurchasing : MonoBehaviour, IStoreListener
{
    ...
    private static string kProductIDSubscription = "remove_ads";          

    private static string kProductNameAppleSubscription = "com.scouterstudios.pickndrop";

    private static string kProductNameGooglePlaySubscription = "com.scouterstudios.pickndrop";
    ...
    void Update()
    {
        ...
        {
            AdsFreeButton.GetComponent<Button>().interactable = false;
        }
    }
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        if (String.Equals(args.purchasedProduct.definition.id, kProductIDSubscription, StringComparison.Ordinal))
        {
            ...
            RemoveAds.control.adsfree = true;
            RemoveAds.control.save();
        }
